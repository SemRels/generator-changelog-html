...
LABEL org.opencontainers.image.title="semrel-plugin-generator-changelog-html" \
      org.opencontainers.image.description="semrel plugin: generator-changelog-html" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/generator-changelog-html" \
